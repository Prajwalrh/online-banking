...
<div class="cnfrm_info">
	 ...
	 <span><?php echo "Pan  : ".$_SESSION['cust_Pan']."<br>"; ?>  </span>
	 <span><?php echo "AdharNumber : ".$_SESSION['cust_AdharNumber']."<br>"; ?> </span>
	 ...
	 <span><?php echo "Area/Locality : ".$_SESSION['arealocation']."<br>"; ?> </span>
...
if(isset($_POST['cnfrm-submit'])){ 
	...
	$citizenship=$_SESSION['cust_AdharNumber'];
